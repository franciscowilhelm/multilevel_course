...
Im ersten Schritt machen wir mit `pivot_longer()` den Datensatz seehr lang, es bekommt nämlich jede Messung von jeder Variable ihre eigenen Zeile.
...
Die Funktionsweise von pivot_longer() und pivot_wider() ist in der [Einführung zu R](https://methodenlehre.github.io/einfuehrung-in-R/chapters/04-tidyverse.html#4_3_reshaping) beschrieben.
